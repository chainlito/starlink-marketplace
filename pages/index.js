    ...
    return (
        <Flex bg="transparent" w="100%" h="100%">
            <Flex w="100%" h="750px" justifyContent="flex-end">
                <Flex flexDirection="column" bg="rgba(29,37,63,0.6)" ml="1rem" mr={["1rem", "2rem", "5rem", "10rem", "15rem"]} mt={["50px", "50px", "150px"]} borderRadius="20px" alignSelf="center" p="30px 50px 30px 50px">
