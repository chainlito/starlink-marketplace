...
const Home = () => {
    return (
        <Flex bg="transparent" w="100%" h="100%">
            <Flex w="100%" h="750px" justifyContent="flex-start">
                <Flex flexDirection="column" bg="rgba(29,37,63,0.6)" h="270px" ml="10rem" mt="150px" borderRadius="20px" alignSelf="center" p="30px 70px 30px 70px">
                    <Text fontSize="20px" textColor="#0084ff" fontWeight="700">Coming Soon</Text>
                    <Text fontSize="45px" textColor="white" fontWeight="700">3D UNIVERSE</Text>
                    <Text fontSize="15px" maxW="350px" textColor="white">Product is being built by the community</Text>
            ...
            >
                <source src="metaverse.mov" type="video/mp4" />
            </video>
        </Flex>
    );
};
